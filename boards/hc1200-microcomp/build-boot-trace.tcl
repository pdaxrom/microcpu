...
if {[catch {
    prj_project open microcomp-boot-trace.ldf
    prj_run Synthesis -impl impl1
    prj_run Translate -impl impl1
    prj_run Map -impl impl1
    prj_run PAR -impl impl1
    prj_run PAR -impl impl1 -task PARTrace
    set report [open impl1-boot-trace/microcomp-boot-trace_impl1.twr r]
    ...
    puts stderr "HC1200 boot trace build failed: $message"
    exit 1
}
exit 0
