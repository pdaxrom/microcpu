...
BOOT_TRACE_BIN = hc1200-microcomp/j11_boot_trace.bin
BOOT_TRACE_MEM = hc1200-microcomp/j11_boot_trace.mem
BOOT_TRACE_EBR = hc1200-microcomp/boot_trace_ebr.v
...
# Isolated, no-FIS boot trace. Normal SD and standalone diagnostic images stay intact.
$(BOOT_TRACE_BIN): $(SD_DEPS) ../ucode/diagnostics/boot_trace.asm $(MICROASM) sd.mk ../ucode/config.mk
	$(MICROASM) --cpu ucode -D J11_DISK_PROTOTYPE -D J11_SD_AUTOBOOT -D J11_DISABLE_FIS -D J11_BOOT_TRACE --list hc1200-microcomp/j11_boot_trace.lst -binary ../ucode/v2/j11.asm $@
$(BOOT_TRACE_MEM): $(BOOT_TRACE_BIN) ../ucode/make_urom_ebr.py ../ucode/config.mk sd.mk
	$(PYTHON) ../ucode/make_urom_ebr.py $< --words $(J11_UROM_WORDS) --format mem > $@
$(BOOT_TRACE_EBR): $(BOOT_TRACE_BIN) ../ucode/make_urom_ebr.py ../ucode/config.mk sd.mk
	$(PYTHON) ../ucode/make_urom_ebr.py $< --words $(J11_UROM_WORDS) --module-name ucode_urom_ebr > $@
.PHONY: hc1200-boot-trace hc1200-boot-trace-diamond
hc1200-boot-trace: $(BOOT_TRACE_MEM) $(BOOT_TRACE_EBR)
hc1200-boot-trace-diamond: hc1200-boot-trace
	cd hc1200-microcomp && LD_PRELOAD="$(DIAMOND_LIBSTDCPP)" "$(DIAMOND_HOME)/bin/lin64/diamondc" build-boot-trace.tcl
