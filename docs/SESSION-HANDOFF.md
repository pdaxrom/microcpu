...
физическое подтверждение нового RT-11 boot по UART пока ожидается.
...
Подтверждение вывода нового RT-11 boot из пользовательского UART ещё
ожидается: терминал оставлен открытым, параллельного чтения порта не было.
