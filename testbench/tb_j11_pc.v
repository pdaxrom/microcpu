...
module tb_j11_pc;
	...
	initial begin
		...
		dut.urom_data = 0;
		dut.urom_data[7:4] = dut.INST_MOV;
		...
		for (i = 0; i < 11; i = i + 1)
			for (offset = -1024; offset < 1024; offset = offset + 1) begin
				...
				dut.urom_data = 0;
				dut.urom_data[7:4] = dut.INST_B;
				dut.urom_data[15:8] = offset;
				dut.urom_data[2:0] = offset >>> 8;
				...
				for (j = 0; j < 11; j = j + 1)
					for (k = 0; k < 11; k = k + 1) begin
						...
						for (condition = 0; condition < 8; condition = condition + 1) begin
							...
							dut.urom_data = 0;
							dut.urom_data[7:4] = operation ? dut.ALU_BIT : dut.ALU_CMP;
							dut.urom_data[3] = 1;
							dut.urom_data[2:0] = condition;
