...
// Specialized microcode ISA, selected by microasm --cpu ucode.
// The preserved j11_microengine is the v1 reference, not a wrapper around this core.
module ucode_cpu #(
	...
	// Both immediate and indexed context operations reach all 64 words.
	// Their architectural meaning and register-bank switching stay in firmware.
	...
	ucode_urom_ebr #(.WORDS(UROM_WORDS)) microcode_rom (
